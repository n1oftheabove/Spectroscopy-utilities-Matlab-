***rad_exposure_calculator.m*** calculates the radiant exposure of an incident pulsed laser beam on your sample in the commonly used unit Milli-Joules per square centimeters.
